...
IF "%1"=="" (
	...
	venv\Scripts\pyinstaller --specpath installer/build  --add-data "../../icons/*;." --icon "C:/Users/Stefano/PycharmProjects/HIL_tools/icons/test_new.ico" --onefile --distpath installer --clean --workpath installer/build --name TC_tool_v%1 main.py
)