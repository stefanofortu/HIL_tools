...
source_filename = "C:\\Users\\Stefano\\Desktop\\WIP\\HIL_1805\\HIL\\TC_AF\\2-TC_Build\\TC_AF_CheckConf_Build.xlsx"
source_sheet = "TC_AF_Configuration"
destination_filename = "C:\\Users\\Stefano\\Desktop\\WIP\\HIL_1805\\HIL\\TC_AF\\3-TC_Run\\TC_AF_CheckConf_Run.xlsx"
...
#wsEnd = deepcopy(wsStart)


#wbEnd = Workbook()
#wsEnd = wbEnd.active
#wsEnd.title = source_sheet
# wbEnd = load_workbook(destination_filename)
...
substituteExpressionsByRowsV2(worksheetStart=wsStart,
                            worksheetEnd=wsEnd,
                            substitutionDictionary=functionDictionary)
